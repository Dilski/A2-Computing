...
if (empty($deleteId)) header('location: viewUsers.php');
...
$query = mysql_query("DELETE FROM `login` where `id` = '".$deleteId."'", $connection);
        	...
        	<div class="well well-sm text-center">
	        	...
	        	<div class="row">
	        		<div class="col-md-12 text-center">
			        	...
			        	<h4> Username: <?php echo($deleteUsername); ?> </h4>
				...
				<div class="row">
					...
					<div class="col-md-12 text-left">
						<a class="btn btn-danger btn-lg pull-left" href="viewUsers.php"><i class="fa fa-times"></i> no </a>
